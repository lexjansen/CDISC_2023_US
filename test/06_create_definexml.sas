...
%let _cstDefineFile=define_sdtm_3.3_minimal;
...
%cstutil_setcstsroot;
data _null_;
  call symput('studyRootPath',"&project_folder/&subfolder");
  call symput('studyOutputPath',"&project_folder/&subfolder");
run;
...
proc sql;
  ...
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "study"       "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_study"          "")
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "standard"    "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_standards"      "")
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "table"       "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_tables"         "")
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "column"      "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_columns"        "")
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "codelist"    "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_codelists"      "")
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "value"       "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_values"         "")
  values ("&_cstStandard"  "&_cstStandardVersion" "studymetadata"   "document"    "sampdata" "libref"  "input"  "dataset"  "N"  "" "&studyRootPath/metadata"   .  "source_documents"      "")
